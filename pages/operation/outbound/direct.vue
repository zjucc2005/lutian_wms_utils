<template>
    <uni-section title="1. 设定生产发料通知单" type="square" 
        ...
        <view class="searchbar-container">
            <uni-forms ref="search_form" :model="search_form" :label-width="72" class="search-form">
                <uni-forms-item label="单据编号">
                    <uni-easyinput v-model="search_form.bill_no" trim placeholder="请输入单据编号"
                        @confirm="load_scfltzd" />
                </uni-forms-item>
                <uni-forms-item v-if="scfl.prd_line" label="产线">
                    <view class="form-text">{{ scfl.prd_line }}</view>
                    <!-- <uni-easyinput v-model="scfl.prd_line" disabled style="color: red;" /> -->
    ...
    <uni-section v-if="scfl.bill_no" title="2. 出库扫码" type="square">
        <view class="container">
            <uni-forms 
                ...
                <uni-forms-item label="库位号" name="loc_no">
                    ...
                    <uni-easyinput v-model="form.loc_no" trim :clearable="false" :input-border="false">
                        <template #left>
            ...
            async load_outbound_logs() {
                ...
                for (let d of res.data) {
                    ...
                    for (let de of this.scfl.detail_entity) {
                        if (de.material_no == d['FMaterialId.FNumber'] && de.ppbom_bill_no == ppbom_bill_no) {
