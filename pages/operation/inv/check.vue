    ...
    <uni-section :title="breadcrumb_stockname()" type="square" title-color="#007aff" class="above-uni-goods-nav" @click="debug">
        <uni-table ref="table" class="table-sm" border stripe>
            <uni-tr>
                ...
                <uni-th align="center" width="132">库位</uni-th>
                <uni-th align="center" width="74">批次</uni-th>
...
<script>
    ...
    // #endif
    import { breadcrumb_stockname, formatDate, play_audio_prompt, string_to_arraybuffer, compare_loc_no } from '@/utils'
    ...
    export default {
        ...
        methods: {
            ...
            async get_inv_groups() {
                ...
                let stk_inv_res = await StkInventory.query({ FStockId: this.$store.state.cur_stock.FStockId }, { fields, order: 'FMaterialId.FNumber ASC' })
                let inv_groups = []
                let i = 0, j = 0
