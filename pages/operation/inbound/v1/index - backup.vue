    ...
    export default {
        ...
        methods: {
            ...
            init_pda_scan() {
                ...
                this.pda_scan = pda_scan
                main.registerReceiver(this.pda_scan, filter)
                console.log('main.registerReceiver', this.pda_scan)
            },
            rm_pad_scan() {
                let main = plus.android.runtimeMainActivity()
                main.unregisterReceiver(this.pad_scan)
                console.log('main.unregisterReceiver', this.pda_scan)
            },
            // component
            goods_nav_click(e) {
                if (e.index === 0) {
